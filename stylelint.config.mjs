export default {
  ...
  rules: {
    ...
    // 'function-whitespace-after': 'always', // DEPRICATED
    'function-no-unknown': null,

    'media-feature-name-no-unknown': true,
    'media-feature-name-no-vendor-prefix': true,
    // 'media-feature-range-operator-space-after': 'always', // DEPRICATED
    // 'media-feature-range-operator-space-before': 'always', // DEPRICATED
